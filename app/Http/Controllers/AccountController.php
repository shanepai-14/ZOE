...
class AccountController extends Controller
{
    ...
    public function store(Request $request){
        ...
        Account::create([
            'contract_no'=>$request->input('contract_no'),'name'=>$request->input('name'),'position'=>$request->input('position'),
            'company'=>$request->input('company'), 'address'=>$request->input('address'), 'service_details'=>$request->input('service_details'),
            'subject'=>$request->input('subject'), 'schedule_of_broadcast'=>$request->input('scheduled_of_broadcast'),'start_of_broadcast'=>$request->input('start_of_broadcast'),
            'end_of_broadcast'=>$request->input('end_of_broadcast'), 'billing_rate'=>$request->input('billing_rate')
        ]);

        return Redirect::route('index')->with('success', 'New Account successfully added');
    }
